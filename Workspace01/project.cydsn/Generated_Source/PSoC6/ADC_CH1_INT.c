...
*   #START and #END tags
******************************************************************************/
/* `#START ADC_CH1_SYS_VAR`  */

/* `#END`  */

/******************************************************************************
* Function Name: ADC_CH1_ISR
*******************************************************************************
*
...
void ADC_CH1_ISR(void)
{
    ...
    intr_status = Cy_SAR_GetInterruptStatus(ADC_CH1_SAR__HW);

    /* ISR Macro Callback */
    #ifdef ADC_CH1_ISR_CALLBACK
        ADC_CH1_ISR_Callback();
    #endif
    ...
    *************************************************************************/
    /* `#START MAIN_ADC_CH1_ISR`  */

    /* `#END`  */

    /* Clear handled interrupt */
    Cy_SAR_ClearInterrupt(ADC_CH1_SAR__HW, intr_status);
    /* Read interrupt status register to ensure write completed due to buffered writes */
    (void)Cy_SAR_GetInterruptStatus(ADC_CH1_SAR__HW);
}
